...
export const metadata: Metadata = generateMetadata({
  ...
  description: 'Learn about BM Contracting LLC, Maryland\'s trusted home remodeling contractor with 15+ years of experience. Committed to quality, integrity, and customer satisfaction. Licensed and insured.',
  keywords: [
