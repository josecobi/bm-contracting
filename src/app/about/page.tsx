...
export default function About() {
  return (
    <main className="bg-gray-50 min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              About <span className="bg-gradient-to-r from-yellow-200 to-yellow-400 bg-clip-text text-transparent">BM Contracting</span>
            </h1>
      ...
      {/* Core Values */}
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              whileHover={{ y: -8 }}
            >
              <div className="w-16 h-16 bg-gradient-to-br from-green-700 to-green-500 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
